  ...
  return <>
    ...
    <section className="sales-hero">
      <div className="sales-hero-copy">
        ...
        <p>blio searches your chosen area and business type, enriches each prospect, spots commercial opportunities, and ranks the strongest fits. You spend your time selling—not building another spreadsheet.</p>
      ...
      <div className="sales-hero-steps" aria-label="How blio finds target clients">
    ...
    <section className="card section-card dashboard-cta" style={{ marginTop: 18 }}><div className="dashboard-cta-copy"><p className="eyebrow">A better first touch</p><h2>Research gives you the reason. You bring the relationship.</h2><p>Every blio lead is grounded in public evidence, so your outreach can sound specific without pretending to know more than you do.</p>{campaigns[0] ? <ResearchLaunchButton campaignId={campaigns[0].id} /> : <Link href="/campaigns/new" className="button dashboard-cta-button">Create your first campaign <ArrowRight /></Link>}</div><div className="dashboard-cta-orbit" /></section>
  </>;
}
