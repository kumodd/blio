  ...
  return <div className="landing-page">
    <section className="landing-hero">
      <div className="landing-hero-copy">
        ...
        <p className="landing-lead">Tell QuickLeads what you sell, who you want to reach, and where. It finds matching businesses, explains why they may need help, and gives you a relevant reason to start the conversation.</p>
