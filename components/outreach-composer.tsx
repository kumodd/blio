...
import type { OutreachDraft, OutreachChannel } from "@/lib/types";
...
export function OutreachComposer({ leadId, phone, email, instagram, initialDrafts }: { leadId: string; phone?: string; email?: string; instagram?: string; initialDrafts: OutreachDraft[] }) {
